...
namespace nnnn.Controllers
{
    public class TasksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TaskInfo,TaskCategory")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TaskInfo,TaskCategory")] Task task)
        {
            if (id != task.Id)
            {
                return NotFound();
